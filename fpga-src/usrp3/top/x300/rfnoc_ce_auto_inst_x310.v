...
noc_block_split_stream  inst_split_stream (
...
noc_block_split_stream  inst_split_stream2 (
  .bus_clk(bus_clk), .bus_rst(bus_rst),
  .ce_clk(ce_clk), .ce_rst(ce_rst),
...
noc_block_split_stream  inst_split_stream3 (
  .bus_clk(bus_clk), .bus_rst(bus_rst),
  .ce_clk(ce_clk), .ce_rst(ce_rst),
...
noc_block_split_stream  inst_split_stream4 (
  .bus_clk(bus_clk), .bus_rst(bus_rst),
  .ce_clk(ce_clk), .ce_rst(ce_rst),
